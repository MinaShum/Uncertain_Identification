...
- `TestRun`: This folder contains a working example for reading the data, simulation, fitting linear moels and using STAN model to fit a variational bayes on one simulation scenario of horse dataset. 
<br>
